            ...
            <div className="centerContainerOverride flex flex-column justify-start">
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-column items-end">
                        <p className= "f4 bb montSerrat dark-green-text mr5 mt1 mb1 pointer" onClick={this.handleChangePasswordClick}> Schimbare parola </p>
                        {
                ...
                <div className="flex flex-row justify-center">
                    <div  className="bg-transparent br3 pa3 pt1 ma2 grow shadow-5 bw w-50 tc ml5">
                            <h5 className="montSerrat pink-dark-text bb">Date personale</h5>
                            <p className= "f4 poiret b black-text mt1 mb1"> Total meciuri jucate: </p>
                            <p className= "f5 montSerrat dark-green-text mt0"> {personalProcessedData.totalMatchesPlayed}</p>
                            
                            <p className= "f4 poiret b black-text mt1 mb1"> Castiguri: </p>
                            <p className= "f5 montSerrat dark-green-text mt0"> {personalProcessedData.numberOfWins}</p>
                            
                            <p className= "f4 poiret b black-text mt1 mb1"> Rata castig: </p>
                            <p className= "f5 montSerrat dark-green-text mt0"> {`${personalProcessedData.performance}%`}</p>
                            
                            <p className= "f4 poiret b black-text mt1 mb1"> Jocul preferat: </p>
